            ...
            <ul class="dropdown-menu notify-drop">
              ...
              <?php foreach($notifdetails as $notifdetail){?>
                <li>
                  ...
                  <div class="col-md-9 col-sm-9 col-xs-9 pd-l0"><a href=""><?php echo $notifdetail->fname." ";?><?php echo $notifdetail->lname." ";?></a> commented on your<a href="" style="color: red;text-transform: lowercase;"> post</a> in BSIS
                  <a href="" class=""><i class="fa fa-settings"></i></a>
                    <hr>
                    <p class="time">Tue 7:30 PM</p>
                  </div>
                </li>
                <?php }?>
              </div>
...
<h3>&nbsp;&nbsp;&nbsp;<a href ="profile/<?php echo $userid =  $notifdetail->idnumber." " ;?>">
<?php echo $notifdetail->fname." ";?><?php echo $notifdetail->mname." ";?><?php echo $notifdetail->lname." ";?></a></h3>

<h5>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $notifdetail->post_date." ";?> <?php echo $notifdetail->post_time." ";?></h5>
</td></tr></table>
<br><h4>
<?php echo $notifdetail->text." ";?></h4>
...
<div id="comment<?php echo $notifdetail->stat_id;?>" >
    ...
    <input type="text" id="comments<?php echo $notifdetail->stat_id;?>" name="comments" placeholder="Write a comment" style="width: 250px">
    <a data-toggle="collapse" data-parent="#accordion" href="#smiley<?php echo $notifdetail->stat_id;?>">
    ...
    <div id="smiley<?php echo $notifdetail->stat_id;?>" class="collapse" style="float: right;padding-top: 5px;">
      <?php echo $smiley_tables; ?></div>
      </form>
    <hr style="margin-bottom: 10px;margin-top: 10px;">

    <?php foreach($comments as $comment){?>
        <?php $a = $notifdetail->stat_id; $b = $comment->status_id; if($a==$b) { ?>
    <table width="500px">
    ...
    <?php $a = $notifdetail->stat_id; $b = $comment->status_id; if($a==$b) { echo $comment->fname." ";?><?php echo $comment->lname." ";}?></strong></font>
    <?php $a = $notifdetail->stat_id; $b = $comment->status_id; if($a==$b) { echo $comment->comments." ";}?>
        <h6 style="float: right;margin: 0px;margin-right: 12px; font-size: 13px;">
    <?php $a = $notifdetail->stat_id; $b = $comment->status_id; if($a==$b) { echo $comment->comment_date." ";?>| <?php echo $comment->comment_time." ";}?></h6> </td></tr></table> 
